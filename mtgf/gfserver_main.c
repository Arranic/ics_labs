...
extern void setNumThreads(size_t numThreads);

steque_t *reqQue;                                   // request queue to hold requests
pthread_mutex_t mutex = PTHREAD_MUTEX_INITIALIZER;  // init the mutex
pthread_cond_t prodCond = PTHREAD_COND_INITIALIZER; // init the producer mutex
...
int main(int argc, char **argv)
{
    ...
    reqQue = malloc(BUFSIZ);
    steque_init(reqQue); // initialize the queue

    printf("start setting options\n");
